...
export const AMILY_VILLAGE_ENCOUNTERS_DISABLED =
...
export const AMILY_HERM_TIMES_FUCKED_BY_FEMPC =
...
export const TAMANI_DAUGHTER_PREGGO_COUNTDOWN =
  'Tamani_Daughter_Preggo_Countdown';
...
export const TIMES_RIDDEN_KELLY_FOR_PUNISHMENT =
  'Times_Ridden_Kelly_For_Punishment';
...
export const TIME_SINCE_LAST_CONSUMED_MINOTAUR_CUM =
  'Time_Since_Last_Consumed_Minotaur_Cum'; // Timer for cum problems
export const EVER_DRANK_MINOCUM = 'Ever_Drank_Minocum'; // Used for playerinfo menu
export const MINOTAUR_CUM_REALLY_ADDICTED_STATE =
...
// Bee Girl
export const BEE_GIRL_COMBAT_WINS_WITHOUT_RAPE =
  'Bee_Girl_Combat_Wins_Without_Rape';
...
export const TIMES_THOUGHT_ABOUT_GOO_RECRUITMENT =
  'Times_Thought_About_Goo_Recruitment';
