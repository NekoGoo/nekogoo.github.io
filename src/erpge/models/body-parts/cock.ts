class Cock {
  ...
  increaseCock(amount: number, hyperHappy = false): number {
    ...
    if (!hyperHappy) {
      ...
      else if (this.cockLength >= 50 && this.cockLength < 70) amount *= 0.6;
      else if (this.cockLength >= 70 && this.cockLength < 90) amount *= 0.5;
      else if (this.cockLength >= 90 && this.cockLength < 120) amount *= 0.4;
      else if (this.cockLength >= 120) amount *= 0.3;
    }
    // Apply growth
  ...
  thickenCock(amount: number, hyperHappy = false): number {
    // Diminishing returns!
    if (!hyperHappy) {
      if (this.cockThickness >= 6 && this.cockThickness < 10) amount *= 0.8;
      else if (this.cockThickness >= 10 && this.cockThickness < 14) amount *= 0.6;
      else if (this.cockThickness >= 14 && this.cockThickness < 18) amount *= 0.5;
      else if (this.cockThickness >= 18 && this.cockThickness < 24) amount *= 0.4;
      else if (this.cockThickness >= 24) amount *= 0.3;
    }
    // Apply growth
